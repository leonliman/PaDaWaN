...
public class SolrQueryStringVisitor implements IQueryElementVisitor<String> {
  ...
  public String visit(QueryRoot queryElem) throws QueryException {
    ...
    double version = Double.parseDouble(queryElem.getVersion());
    if (version >= 0.7) {
      if (queryElem.getFilterIDTypeToUseForCount() == QueryIDFilter.FilterIDType.PID) {
