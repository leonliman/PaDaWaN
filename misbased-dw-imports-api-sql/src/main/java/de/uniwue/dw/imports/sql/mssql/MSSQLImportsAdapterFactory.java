...
public class MSSQLImportsAdapterFactory implements IImportsAdapterFactory {

  @Override
  public ICaseImportAdapter createCaseImportAdapter(CaseManager caseManager) throws SQLException {
    return new MSSQLCaseImportAdapter(SQLPropertiesConfiguration.getInstance().getSQLManager(), caseManager);
  }


  @Override
  public IPatientImportAdapter createPatientImportAdapter(PatientManager patientManager) throws SQLException {
    return new MSSQLPatientImportAdapter(SQLPropertiesConfiguration.getInstance().getSQLManager(), patientManager);
  }


  @Override
  public IDocImportAdapter createDocImportAdapter(DocManager docManager) throws SQLException {
    return new MSSQLDocImportAdapter(SQLPropertiesConfiguration.getInstance().getSQLManager(), docManager);
  }


  @Override
  public IRefIDAdapter createRefIDImportAdapter(InfoManager ainfoManager) throws SQLException {
    return new MSSQLRefIDAdapter(SQLPropertiesConfiguration.getInstance().getSQLManager(), ainfoManager);
  }


  public IImportLogHandlerAdapter createLogHandlerAdapter() throws SQLException {
    return new MSSQLImportLogHandler(SQLPropertiesConfiguration.getInstance().getSQLManager(),
